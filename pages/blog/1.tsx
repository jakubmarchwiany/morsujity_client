      ...
      <Typography mt={10} mb={5} variant="body1" mx={10}>
        <div>
          <Typography variant="h6">
            ZASADY BEZPIECZNEGO ZIMOWEGO PŁYWANIA
          </Typography>
          <div>
            &bull; Uprzednia adaptacja do niższych temperatur(np. za pomocą
            zimnych prysznic&oacute;w).
          </div>
          <div>
            &bull; Spokojna rozgrzewka trwająca od 10 do 15 minut. Ma nas
            rozgrzać, ale nie spocić.
          </div>
          <div>
            &bull; Rozbieramy się zaczynając od dołu do g&oacute;ry, ubieramy
            odwrotnie po wytarciu całego ciała.
          </div>
          <div>
            &bull; Na wejście do wody możemy zabrać obuwie(od but&oacute;w
            neoprenowych po zwykłe klapki). Kwestia odłamk&oacute;w
            szkła/poślizgnięcia się na lodzie.
          </div>
          <div>
            &bull; Czas kąpieli uzależniony jest od naszego stażu,
            warunk&oacute;w pogodowych i aktualnego samopoczucia, nie
            przesadzamy. To samo odnosi się do częstotliwości morsowania.
          </div>
          <div>
            &bull; Przed samą kąpielą, tak jak przed każdym treningiem, trzeba
            być wypoczętym, odżywionym i nawodnionym oraz nie wolno korzystać z
            jakichkolwiek używek takich, jak papierosy czy alkohol. Nap&oacute;j
            z procentami dodatkowo wychładza organizm, obniża ciśnienie krwi
            oraz może powodować skurcze uniemożliwiające ruch w wodzie.
          </div>
        </div>
        <div>
          <Typography variant="h6">
